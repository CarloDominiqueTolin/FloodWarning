...
def goToMonth(browser,targetDate):
    ...
    tmp_df.to_csv(f'{targetDate.year}_{targetDate.month}_pagasa.csv', index=False)
...
if __name__ == "__main__":
    ...
    goToMonth(browser,dt.datetime(2013,3,2))

    print(pd.read_csv('2013_3_pagasa.csv')['location'].value_counts())
